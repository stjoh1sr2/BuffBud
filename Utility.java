...
public class Utility extends GameWindow {

	public Utility(Stage stage) throws FileNotFoundException, InterruptedException {
		super(stage);
	...
	public static void save() {
		...
		try {
			...
			writer = new PrintWriter("Pet.txt");
		...
		writer.println(pet.getPetName() + "," + pet.getHealthLevel() + "," + pet.getTimeOfLastExcersize());
		writer.close();
