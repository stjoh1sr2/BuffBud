...
public class IntroWindow {
	...
	ImageView maleIcon = new ImageView("file:Images/male.png");
	Image femaleIcon = new Image("file:Images/female.png");
	
	// Introductory screen
	FlowPane intro = new FlowPane();
	Scene introScene = new Scene(intro, 375, 100);
	...
	// Background
	Image introBackgroundImage = new Image("file:Images/IntroScreen.png");
